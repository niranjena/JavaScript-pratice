...
var showPlayerInfo = function (playerName, playerPlace, playerHealth) {
    ...
    console.log(line.substring(0,1)+ " " +playerName+" "+line.substring(0,1));
    console.log(line.substring(0,10));


    var dash ="----------------"
    console.log(dash.substring(0,10));
    console.log(dash.substring(0,1)+ " " +playerName+" "+line.substring(0,1));
